...
import migration.util.Distributions;
...
public class Parameters {
	...
	public final static String[] DEFAULT_ARGS = {"-file","data/parameters/phase.param"};
	private final static String A_FILE = "-file";
	public final static String PARAMETER_FILE = "data/parameters/phase.param";
	public final static double DEFAULT_COEFF = 0.25;
	
	public final Distributions distributions;
	...
	public double urbanSocialExp = 3;
	...
	public double ruralSocialExp = 3;
	 ...
	 * @param args If the file is null, then it create a empty parameter database
	 * other wise, it use the generate a parameter database use the provided parameter file
	 */
     ...
     *
     * @param args contains path to the parameter file
...
//                    parameters = new ParameterDatabase(parameterDatabaseFile.getAbsoluteFile());
    ...
    private void loadParameters(ParameterDatabase parameterDB)
    {
        ...
        // Phase4 parameters
        recordData = Utility.returnBooleanParameter(parameterDB, "recordData", false);
    	...
    	urbanSocialExp = Utility.returnDoubleParameter(parameterDB, "urbanSocialExp", 3);
        ...
        ruralSocialExp = Utility.returnDoubleParameter(parameterDB, "ruralSocialExp", 3);
